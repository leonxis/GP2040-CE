...
// MCP3208 插件默认：禁用，SPI/CS 保持未设置
#define MCP3208_DEFAULT_ENABLED 0
#define MCP3208_DEFAULT_SPI_BLOCK -1
#define MCP3208_DEFAULT_CS_PIN -1
#define MCP3208_DEFAULT_CONVST_PIN -1
// ADS8332 插件默认：启用，SPI 模块 spi0，片选 CS=1，CONVST=4
#define ADS8332_DEFAULT_ENABLED 1
#define ADS8332_DEFAULT_SPI_BLOCK 0
#define ADS8332_DEFAULT_CS_PIN 1
#define ADS8332_DEFAULT_CONVST_PIN 4
