...
#include "gpdriver.h"
#include "drivers/ps4b/PS4BDescriptors.h"
#include "drivers/hid/HIDDescriptors.h"  // For HIDReport and HIDKeyboardReport structures
...
private:
    uint8_t last_gamepad_report[CFG_TUD_ENDPOINT0_SIZE] = { };
    uint8_t last_keyboard_report[8] = { }; // modifier(1) + reserved(1) + keycode[6] = 8 bytes
    HIDReport gamepadReport;
