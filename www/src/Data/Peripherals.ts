export const I2C_BLOCKS = [
	{
		label: 'i2c0',
		value: 0,
		pins: { sda: [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44], scl: [1, 5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45] },
	},
	{
		label: 'i2c1',
		value: 1,
		pins: { sda: [2, 6, 10, 14, 18, 22, 26, 30, 34, 38, 42, 46], scl: [3, 7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47] },
	},
];
