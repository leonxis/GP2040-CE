export default {
	...
	'hml-quick-mode-title': 'Quick mode switch',
	'hml-quick-mode-line-firmware': 'Hold SHARE + OPTION + L1 for 4 seconds to switch to firmware upgrade mode.',
	'hml-quick-mode-line-webconfig': 'Hold SHARE + OPTION + R1 for 4 seconds to switch to web configuration mode.',
	'hml-quick-mode-line-inputmode': 'Hold SHARE + OPTION + one key below for 4 seconds to switch to the mapped controller mode.',
	'hml-quick-mode-label-x': 'Cross button',
	'hml-quick-mode-label-o': 'Circle button',
	'hml-quick-mode-label-square': 'Square button',
	'hml-quick-mode-label-triangle': 'Triangle button',
	'hml-quick-mode-disabled': 'Disabled',
	'hml-loading': 'Loading…',
	...
	'hml-upgrade-manual-modal-title': 'Firmware copy instructions',
	'hml-upgrade-manual-modal-step1':
		'1. The browser will download the upgrade firmware.',
	'hml-upgrade-manual-modal-step2':
		'2. Manually copy the downloaded {{uf2File}} to the RPI-RP2 drive on your computer to finish upgrading.',
	...
	'hml-cpu-overclock-normal': 'Normal (180MHz)',
	'hml-cpu-overclock-moderate': 'Moderate (204MHz)',
	'hml-cpu-overclock-heavy': 'Heavy (240MHz)',
	'hml-cpu-overclock-extreme': 'Extreme (288MHz)',
};
