export default {
	...
	'hml-upgrade-instruction-3': '3. 書き込みモードで「ファームウェアアップグレード」を押して再起動を待ちます。',
	...
	'hml-section-function-buttons': 'ファンクションキー',
	'hml-section-stick-config': 'スティック設定',
	'hml-section-dpad-config': '十字キー設定',
	'hml-hotkey-settings-button': 'ホットキー設定',
	'hml-hotkey-settings-hint': 'ホットキーにはFnボタンを割り当ててください。',
	'hml-macro-settings-button': 'マクロ設定',
