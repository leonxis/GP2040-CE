export default {
	...
	'hml-button-settings-row-key-settings': '按键设置',
	'hml-button-settings-row-back-settings': '背键设置',
	'hml-button-settings-row-hotkey-settings': '热键设置',
	'hml-button-settings-row-macro-settings': '宏键设置',
	'hml-button-settings-hub-desc-key-swap': '手柄原生按键映射调整，支持组合、宏，支持6套方案，可热切换。',
