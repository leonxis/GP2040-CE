export default {
	...
	'hotkey-actions': {
		...
		'apply-curve-preset-3-left': '应用摇杆曲线预设方案 #3 (左摇杆)',
	...
	'hml-section-function-buttons': '功能按键',
	'hml-section-stick-config': '摇杆配置',
	'hml-section-dpad-config': '方向键配置',
	'hml-hotkey-settings-button': '热键设置',
	'hml-hotkey-settings-hint': '热键需要在将某个按键设为FN键以实现热键功能。',
	'hml-macro-settings-button': '宏设置',
