...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(config.gamepadOptions, dpadTriggerThreshold, 10);
    INIT_UNSET_PROPERTY(config.gamepadOptions, dpadDeadzone, 10);
    ...
    // Note: even if I2C block is disabled, we still keep SDA/SCL pin defaults from BoardConfig
    // so add-ons that repurpose I2C pins as GPIO can discover them.
    INIT_UNSET_PROPERTY(peripheralOptions.blockI2C0, sda, I2C0_PIN_SDA);
    INIT_UNSET_PROPERTY(peripheralOptions.blockI2C0, scl, I2C0_PIN_SCL);
    ...
    INIT_UNSET_PROPERTY(peripheralOptions.blockI2C1, sda, I2C1_PIN_SDA);
    INIT_UNSET_PROPERTY(peripheralOptions.blockI2C1, scl, I2C1_PIN_SCL);
    ...
    INIT_UNSET_PROPERTY(config.animationOptions, alBreathBrightnessCustomX, AMBIENT_BREATH_COLOR_BRIGHTNESS);
    ...
    INIT_UNSET_PROPERTY(config.animationOptions, webConfigAmbientHintEnabled, true);
    ...
    // forced_circularity removed - replaced by range calibration
