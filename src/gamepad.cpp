...
void Gamepad::setup()
{
	...
	for (Pin_t pin = 0; pin < (Pin_t)NUM_BANK0_GPIOS; pin++)
	{
		switch (pinMappings[pin].action) {
			...
			case GpioAction::KEYBOARD_KEY_A:	mapKeyboardKeyA->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_B:	mapKeyboardKeyB->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_C:	mapKeyboardKeyC->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_D:	mapKeyboardKeyD->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_E:	mapKeyboardKeyE->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_F:	mapKeyboardKeyF->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_G:	mapKeyboardKeyG->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_H:	mapKeyboardKeyH->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_I:	mapKeyboardKeyI->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_J:	mapKeyboardKeyJ->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_K:	mapKeyboardKeyK->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_L:	mapKeyboardKeyL->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_M:	mapKeyboardKeyM->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_N:	mapKeyboardKeyN->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_O:	mapKeyboardKeyO->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_P:	mapKeyboardKeyP->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_Q:	mapKeyboardKeyQ->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_R:	mapKeyboardKeyR->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_S:	mapKeyboardKeyS->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_T:	mapKeyboardKeyT->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_U:	mapKeyboardKeyU->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_V:	mapKeyboardKeyV->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_W:	mapKeyboardKeyW->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_X:	mapKeyboardKeyX->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_Y:	mapKeyboardKeyY->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_Z:	mapKeyboardKeyZ->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_CTRL:	mapKeyboardKeyCtrl->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_SHIFT:	mapKeyboardKeyShift->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_ALT_F4:	mapKeyboardKeyAltF4->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_0:	mapKeyboardKey0->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_1:	mapKeyboardKey1->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_2:	mapKeyboardKey2->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_3:	mapKeyboardKey3->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_4:	mapKeyboardKey4->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_5:	mapKeyboardKey5->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_6:	mapKeyboardKey6->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_7:	mapKeyboardKey7->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_8:	mapKeyboardKey8->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::KEYBOARD_KEY_9:	mapKeyboardKey9->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::MOUSE_LEFT_BUTTON:	mapMouseButtonLeft->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::MOUSE_RIGHT_BUTTON:	mapMouseButtonRight->pinMask |= Mask_t{1} << pin; break;
			case GpioAction::MOUSE_MIDDLE_BUTTON:	mapMouseButtonMiddle->pinMask |= Mask_t{1} << pin; break;
			default:				break;
		}
	}
